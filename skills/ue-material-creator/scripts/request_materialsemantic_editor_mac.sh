...
Options:
  --mode <import-root|import|normalize>
...
This does not launch UnrealEditor-Cmd. It writes a MaterialSemanticCommandlet-shaped request
to Saved/MaterialSemanticBridge/request.json for the already-running Unreal Editor to process.
EOF
}
